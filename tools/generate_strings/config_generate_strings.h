...
//
// Utility to generate compressed messages and BASIC keywords - config file
//
...
// BASIC errors and misc strings - all the dialects
...
const std::list<StringEntry> LIST_Kernal =
{
    ...
    { true,  true,  true,  true,  "KMSG_02",   "\rLOADING"                 }, // XXX __msg_kernalloading
    { true,  true,  true,  true,  "KMSG_03",   "\rVERIFYING"               }, // XXX __msg_kernalverifying
    { true,  true,  true,  true,  "KMSG_04",   "\rSAVING"                  }, // XXX __msg_kernalsaving
    { true,  true,  true,  true,  "KMSG_05",   " FROM $"                   }, // XXX __msg_kernalfrom_hex
    { true,  true,  true,  true,  "KMSG_06",   " TO $"                     }, // XXX __msg_kernalto_hex
	
    { true,  true,  true,  true,  "KMSG_07",   "\rPRESS PLAY ON TAPE\r"    }, // XXX __msg_kernalplay
    { true,  true,  true,  true,  "KMSG_08",   "FOUND "                    }, // XXX __msg_kernalfound
    { false, true,  false, false, "KMSG_09",   "OK\r\rSEARCHING"           }, // XXX __msg_kernaloksearch
